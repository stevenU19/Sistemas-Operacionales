...
En la espera activa, un proceso que intenta adquirir un recurso compartido entra en un bucle mientras espera a que el recurso se libere, verificando periódicamente si el recurso está disponible. Si otros procesos siguen adquiriendo y liberando el recurso de manera constante, el proceso en espera puede quedarse esperando indefinidamente, sin llegar a adquirir el recurso. A esto se le llama bloqueo por inanición, ya que el proceso se queda "inánime" o inactivo. El bloqueo por inanición puede ser un problema grave en sistemas en tiempo real o sistemas críticos, donde la respuesta debe ser rápida y predecible. Para evitar este problema, se pueden implementar técnicas como el envejecimiento de procesos en espera, donde los procesos en espera se les da prioridad después de cierto tiempo para que puedan adquirir el recurso. 
